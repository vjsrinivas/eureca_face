...
do
    export MXNET_CUDNN_AUTOTUNE_DEFAULT=0;python eval.py --val_file ../NOISES/gaussian_noise/$noise/val.txt
done
...
do
    export MXNET_CUDNN_AUTOTUNE_DEFAULT=0;python eval.py --val_file ../NOISES/poisson/$noise/val.txt
done
...
do
    export MXNET_CUDNN_AUTOTUNE_DEFAULT=0;python eval.py --val_file ../NOISES/salt_pepper/$noise/val.txt
done
...
#do
#    export MXNET_CUDNN_AUTOTUNE_DEFAULT=0;python eval.py --val_file ../NOISES/speckle/$noise/val.txt
#done

GAMMA_PARAM=( 0.000000 40.000000 80.000000 120.000000 160.000000 200.000000 240.000000 280.000000)
for noise in "${GAMMA_PARAM[@]}"
do
    export MXNET_CUDNN_AUTOTUNE_DEFAULT=0; python eval.py --val_file ../NOISES/gamma/$noise/val.txt
done
